...
class Migration2 extends Migration { 
  ...
  Future upgrade() async {
		...
		database.addColumn("_User", SchemaColumn("passwordHash", ManagedPropertyType.string, isPrimaryKey: false, autoincrement: false, isIndexed: false, isNullable: false, isUnique: false));
